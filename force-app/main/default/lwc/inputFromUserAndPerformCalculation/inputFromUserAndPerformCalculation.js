...
//we need to convert the input(text) into numnber.
this.firstNumber = +userInputFistNumber;// '+' this plus means here typecasting: conversion from one type to another type.
}
